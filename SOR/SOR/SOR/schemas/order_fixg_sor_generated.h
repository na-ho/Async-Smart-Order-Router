...
#ifndef FLATBUFFERS_GENERATED_ORDERFIXGSOR_MSGSERIALIZATION_H_
#define FLATBUFFERS_GENERATED_ORDERFIXGSOR_MSGSERIALIZATION_H_
...
struct Order_FIXG_SOR FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int32_t>(verifier, VT_SIDE) &&
...
struct Order_FIXG_SORBuilder {
  ...
  void add_order_id(flatbuffers::Offset<flatbuffers::String> order_id) {
    fbb_.AddOffset(Order_FIXG_SOR::VT_ORDER_ID, order_id);
  }
  void add_symbol(flatbuffers::Offset<flatbuffers::String> symbol) {
    fbb_.AddOffset(Order_FIXG_SOR::VT_SYMBOL, symbol);
  }
  void add_side(int32_t side) {
    fbb_.AddElement<int32_t>(Order_FIXG_SOR::VT_SIDE, side, 0);
  }
...
#endif  // FLATBUFFERS_GENERATED_ORDERFIXGSOR_MSGSERIALIZATION_H_
